...
struct Division {
    ...
    Team* teams;
    int teamCount;
// skills iterate jop abhi tk ka max milega uska name store
// skills1 -> 5 -> alice
// skills2 -> 7 -> bob
// skill3 ->  0 => bob
//
...
int main() {
    ...
    Skill skills2[] = {{"C++", 6}, {"Python", 18}};
    Skill skills3[] = {{"Python", 10}, {"ML", 9}};
    Skill skills4[] = {{"Python", 5}, {"ML", 9}};
...
// divPtr->teams
    ...
    Person* pythonExpert = techDiv.findExpert("Python");
    std::cout <<pythonExpert->name  << std::endl;
